...
protected void service(HttpServletRequest req, HttpServletResponse resp)
	...
	String courty=req.getParameter("courty");
	String []likes = req.getParameterValues("like");
	String like = "";
	if(likes!=null)
	for(String temp:likes) {
		like+=temp+",";
	}
	...
	EASYBUY_USER u=new EASYBUY_USER(username, name, rePassWord, sex, year, null, email, mobile, address, courty,like,1);

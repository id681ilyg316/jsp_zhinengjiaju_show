...
<body>
	...
	<div id="position" class="wrap">
		您现在的位置：<a href="indexSelect">智能家居店-网上家居店</a> &gt; <a
			href="selectProductList">家居分类</a> &gt; ${title }
	</div>
	<div id="main" class="wrap">
		<div class="lefter">
			<div class="box">
				...
				<dl>
					<dt>
						<a href="selectProductList">全部家居</a>
					</dt>
					<c:forEach var="f" items="${flist}">
						<dt>
	...
	<div id="footer">Copyright &copy; 2021 智能家居店-网上家居店 All Rights
		Reserved. </div>
</body>
</html>
